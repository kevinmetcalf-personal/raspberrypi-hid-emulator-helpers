...
parser = argparse.ArgumentParser(
    description=(
        "Press Cross repeatedly for the unlimited Guado battles after the "
        "Lake Macalania Cloister of Trials in FFX. Useful with emulator "
        "speed-up for building sphere inventories and sphere levels."
    )
)
